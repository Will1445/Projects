...
def synonyms(word):
    ...
    if lower_word in manual_synonyms:
        synonyms.update(manual_synonyms[lower_word])
...
def write_this_in_english(driver):
    ...
    # Expand contractions
    expanded_sentence = expand(translated_sentence, contraction_map)
    ...
    for i, word in enumerate(translated_words):  
        ...
        # Synonym case    
            ...
            # Closest match case 
                ...
                closest_match = find_closest(lower_word, lower_answers)
