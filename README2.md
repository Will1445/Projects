...
A collection of small, self-contained projects developed to enhance coding skills across multiple languages and technologies.
...
| **[RAT](#remote-access-trojan)** | Remote administration tool | Python, C++, Networking |
...
| **[Hand Tracking](#hand-tracking)** | Gesture-based control system | Machine Learning, OpenCV, macOS |
| **[Epicycles](#epicycles-visualiser)** | Fourier series visualization | Mathematics, Visualization |
| **[Duolingo Solver](#duolingo-solver)** | Language exercise automation | Automation, Web Debugging |
...
- **Features:**
  ...
  - Cross-platform compatibility (C++ client, Python server)
...
- **Functionality:**
  ...
  - Right-hand two-finger activation
